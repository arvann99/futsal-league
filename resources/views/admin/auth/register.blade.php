...
<head>
    ...
    <title>Daftar | Futsal League</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen py-10">
    ...
    <div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-sm border border-gray-100">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-2">Daftar untuk mengelola turnamen Anda sendiri</p>
        </div>
        ...
        <a href="{{ route('auth.google') }}"
           class="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 hover:bg-gray-50 rounded-xl font-medium text-gray-700 transition">
