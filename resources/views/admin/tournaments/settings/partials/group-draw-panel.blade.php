{{--
    N2 — Panel Undian/Drawing tim ke grup (reusable).
    Dipakai oleh halaman Undian standalone (settings/group-draw) maupun di-embed
    ke halaman Bagan Klasemen (standings). Membutuhkan variabel:
...
<div id="drawRoot"
    ...
    @else
        <div class="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 mb-6">
            ...
            <p class="text-amber-300/80 text-xs mb-4">⚠️ Hasil undian akan menimpa penempatan grup saat ini dan menandainya sebagai penempatan tetap (tidak ditimpa auto-assign). Jadwal grup akan diperbarui. Muat ulang halaman untuk melihat klasemen terbaru.</p>
