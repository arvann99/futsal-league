    ...
    <div class="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
        <div class="w-full max-w-3xl rounded-[2rem] border border-white/10 bg-slate-900/90 p-8 shadow-2xl shadow-slate-950/50 backdrop-blur-md">
            ...
            <div class="mt-10 grid gap-4 sm:grid-cols-3">
                ...
                <a href="{{ route('public.statistics.index') }}" class="flex flex-col items-start justify-between rounded-3xl border border-slate-700/80 bg-slate-950/90 p-6 transition hover:-translate-y-1 hover:border-emerald-400/30 hover:bg-slate-900">
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-[0.24em] text-emerald-300">Publik</p>
                        <h2 class="mt-3 text-xl font-semibold text-white">Statistik Turnamen</h2>
                        <p class="mt-2 text-sm text-slate-400">Lihat statistik pemain & tim tanpa perlu login.</p>
                    </div>
