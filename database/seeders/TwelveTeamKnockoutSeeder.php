...
/**
 * Seeder demo: turnamen GUGUR MURNI dengan 12 tim (bukan pangkat 2) untuk
 * memvisualkan bagan bye pada halaman Bracket Gugur.
 *
 * Menghasilkan: 1 turnamen mode 'tournament' (knockout tanpa fase grup),
 * 12 tim approved dengan seed 1..12, setting bracket single-match, lalu
 ...
 */
class TwelveTeamKnockoutSeeder extends Seeder
{
    public function run(): void
    {
        $teamData = [
            ...
            ['name' => 'Cendrawasih FC',     'city' => 'Jayapura'],
            ['name' => 'Komodo United',      'city' => 'Labuan Bajo'],
            ['name' => 'Banteng Muda',       'city' => 'Malang'],
        ];

        // --- Turnamen (reset bila sudah ada) ---
        $tournament = Tournament::firstOrCreate(
            ['name' => 'Demo Gugur 12 Tim 2026'],
            [
                'division'   => 'Open',
        ...
        // Bersihkan peserta lama agar seed 1..12 konsisten tiap run.
        ...
        // --- Tim approved + daftarkan dengan seed 1..12 ---
        ...
        $this->command?->info('12 tim approved didaftarkan dengan seed 1..12.');
